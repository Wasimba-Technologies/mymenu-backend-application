                    ...
                    <div class="mt-2">
                        ...
                        <div class="col-span-3 sm:col-span-3">
                            ...
                            <div class="col-span-3 sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="color" name="primary_color" id="primary_color"  placeholder="Hex Color" v-model="tenantForm.primary_color"
                            ...
                            <div class="col-span-3 sm:col-span-3">
                                ...
                                <div class="mt-1">
                                    <input type="color" name="secondary_color" id="secondary_color"  placeholder="Hex Color" v-model="tenantForm.secondary_color"
