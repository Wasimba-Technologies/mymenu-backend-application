<template>
    <div class="mt-10 p-4 flex flex-col">
        ...
        <div class="mb-4 flex justify-between">
            <h1 class="text-[#740053] text-2xl font-bold">Shawarma 99</h1>
            ...
            <div v-for="product in menu_products" :key="product.id" class="relative flex items-center space-x-2 rounded-lg border border-gray-300 bg-white px-4 py-3 shadow-sm hover:border-[#740053]">
                ...
                <div class="ml-4 flex flex-1 flex-col justify-between">
                    ...
                    <div class="mt-4 flex justify-between">
                        <p class="text-xs font-extrabold text-[#DE2065]">Tsh {{ new Intl.NumberFormat().format(product.price) }}</p>
                        <span class="" @click="addToShoppingCart(product)">
                            <svg class="bg-[#740053] h-4 w-4 rounded-full font-bold text-white cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
